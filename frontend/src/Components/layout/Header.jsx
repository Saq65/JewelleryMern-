    ...
    <>
      ...
      <div className="container-fluid-lg">
        <div className="welcome">
          <div>
            <p>Welcome to the Ramzan Ali Jeweller website</p>
          </div>
        </div>
...

                    {
                      ...
                      >
                        <a onClick={(e) => e.preventDefault()}>
                          <Space>
                            {
                              <p className="text-success fw-semibold">{userName}</p>
                            }
                          </Space>
                        </a>
                      </Dropdown>}
        ...
        <div className="mobile-menu">
          <div className="d-flex justify-content-around align-items-center mt-2">
            ...
            <div className="mt-2">
              {
                user ? <p onClick={() => navigate('/profile')} className="text-white">{userName}</p> : <div onClick={() => navigate('/profile')}>
            ...
            <div onClick={() => navigate('/cart')}>
              ...
              {
                user ? (
                  <sup className="text-light">{carts.length}</sup>
                ) : (
                <span>No items</span>
                )
              }
